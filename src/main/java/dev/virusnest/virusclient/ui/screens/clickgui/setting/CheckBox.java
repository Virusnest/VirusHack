...
public class CheckBox extends Component{
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta){
        ...
        mc.textRenderer.drawWithShadow(matrices,boolSet.getName()+": " + boolSet.isEnabled(), parent.parent.x+textOffset,parent.parent.y+textOffset+offset+parent.offset,boolSet.isEnabled()? Color.decode("#89dceb").getRGB():Color.decode("#cdd6f4").getRGB());
    }
    @Override
